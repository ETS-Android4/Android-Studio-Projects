    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(cold.isChecked() && !fever.isChecked() && !nosmell.isChecked() && !vomit.isChecked())
                {
                    symtoms="Cold cough";
                    diagnosis="only cold";
                ...
                if(cold.isChecked() && fever.isChecked() && !nosmell.isChecked() && !vomit.isChecked())
                {
                    Toast.makeText(getApplicationContext(),"normal fever",Toast.LENGTH_SHORT).show();
                    symtoms="Cold cough"+"\n"+"fever";
                    diagnosis="normal fever";
                }
                if(cold.isChecked() && fever.isChecked() && !nosmell.isChecked() && vomit.isChecked())
                {
                    Toast.makeText(getApplicationContext(),"viral fever",Toast.LENGTH_SHORT).show();
                    symtoms="Cold cough"+"\n"+"fever" +"\n"+"vomiting";
