...
public class MainActivity extends AppCompatActivity {
    ...
    s1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            ...
            e6.setText(String.valueOf(Double.parseDouble(parent.getItemAtPosition(position).toString())*500));
        }
        @Override
    ...
    s2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            n[0] = n[0]+Double.parseDouble(parent.getItemAtPosition(position).toString());
            e7.setText(String.valueOf(Double.parseDouble(parent.getItemAtPosition(position).toString())*100));
        }
        @Override
        public void onNothingSelected(AdapterView<?> parent) {
        }
    ...
    s3.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            n[0] = n[0]+Double.parseDouble(parent.getItemAtPosition(position).toString());
            e8.setText(String.valueOf(Double.parseDouble(parent.getItemAtPosition(position).toString())*200));
        }
        @Override
        public void onNothingSelected(AdapterView<?> parent) {
        }
    ...
    s4.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            n[0] = n[0]+Double.parseDouble(parent.getItemAtPosition(position).toString());
            e9.setText(String.valueOf(Double.parseDouble(parent.getItemAtPosition(position).toString())*300));
        }
        @Override
        public void onNothingSelected(AdapterView<?> parent) {
        }
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                e11.setText(String.valueOf(n[0]));
                Double sum= Double.parseDouble(e6.getText().toString())+
                            Double.parseDouble(e7.getText().toString())+
                            Double.parseDouble(e8.getText().toString())+
                            Double.parseDouble(e9.getText().toString());
                e5.setText(String.valueOf(sum));
                Double sum1=sum-(sum*d[0]);
                e10.setText(String.valueOf(sum1));
